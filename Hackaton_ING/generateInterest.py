...
for y in years:
  for m in months:
	...
	print("%i, %i,%i-%02i-01 00:00:00, , %i, %.3f" % (sub[0], sub[1], y, m, sub[3],i+sub[4]))
        f.write("%i, %i,%i-%02i-01 00:00:00, , %i, %.3f\n" % (sub[0], sub[1], y, m, sub[3],i+sub[4]))
      ...
      for sub in [(3, 9, 'high', 1,0), (3, 8, 'middle', 1,0), (3, 7, 'low', 1,0)]:
        if sub[1] == 7:
          ...
          bs = s
	print("%i, %i,%i-%02i-01 00:00:00, , %i, %.3f" % (sub[0], sub[1], y, m, sub[3],bs))
